...
<p align="center">
  <a href="#why-cairncc">Why</a> &middot;
...
| **CLI Session Import** | Discover and import existing Claude Code CLI sessions into CairnCC |
...
On first launch, CairnCC guides you through:
...
All data is stored locally at `~/.cairncc/` — no cloud, no database.
...
[![Star History Chart](https://api.star-history.com/svg?repos=DRSwanger/CairnCC&type=Date)](https://star-history.com/#DRSwanger/CairnCC&Date)
